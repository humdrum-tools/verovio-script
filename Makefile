...
compile-wasm:
	(cd ../verovio/emscripten && rm -f libverovio.bc && rm -rf CMakeFiles CMakeCache.txt Makefile && source $(EMSDK)/emsdk_env.sh && (cd data && ../../../verovio-script/bin/overlay) && ./buildToolkit -w && cp build/verovio-toolkit-wasm-hum.js ../../verovio-script/scripts/verovio-toolkit-wasm.js && cp build/verovio-toolkit-wasm-hum.js ../../verovio-humdrum-viewer/scripts/local/verovio-toolkit-wasm.js)
